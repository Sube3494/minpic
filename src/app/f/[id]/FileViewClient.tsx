        ...
        >
          ...
          {file.fileType === 'video' ? (
            <div className="relative w-full h-full flex items-center justify-center bg-transparent overflow-hidden">
              ...
              <div 
                className={cn(
                    "absolute flex transition-all duration-500 z-50 [&>div>button]:!bg-transparent [&>div>button]:!text-white [&>div>button]:!border-transparent [&>div>button]:!shadow-none [&>div>button]:!backdrop-blur-none [&>div>button:hover]:!bg-transparent [&>div>button:hover]:!text-white [&>div>span]:hidden [&>div>button>svg]:!h-7 [&>div>button>svg]:!w-7 [&>div>button>svg]:!text-white [&>div>button>svg]:!drop-shadow-none [&>div>button>svg]:stroke-[2.5]",
                   isLandscape
