...
const Toaster = ({ ...props }: ToasterProps) => {
  ...
  return (
    <Sonner
      ...
      toastOptions={{
        className: "backdrop-blur-xl! shadow-[0_20px_25px_-5px_rgba(0,0,0,0.1)]! dark:shadow-[0_20px_25px_-5px_rgba(0,0,0,0.4)]! rounded-2xl! border! border-white/25! dark:border-white/10!",
        classNames: {
          toast: "group",
          content: "w-full!",
          title: "text-sm! font-medium! w-full!",
